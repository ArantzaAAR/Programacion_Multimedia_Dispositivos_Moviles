package com.example.appcuenta001.componentes
...
fun CajaTexto(
    ...
    OutlinedTextField(value = valueState, onValueChange = onValueChangeState,
        ...
        keyboardActions = onAction//si poerde el foco, se baja el teclado
    )
